...
import type { CaseStudyLandingView } from "@/lib/case-study-landing";
...
function SectionHeader({ eyebrow, title, lead }: { eyebrow?: string; title: string; lead?: string }) {
  return (
    <header className="case-landing__header">
      ...
      {lead ? <p className="case-landing__lead">{lead}</p> : null}
    </header>
  );
}

export function CaseStudyLandingPage({
  data,
  buttonLabels,
}: {
  data: CaseStudyLandingView;
    ...
    <article className="case-landing">
      ...
      <section className="case-landing__hero">
        <div className="case-landing__inner">
          <Link href="/#cases" className="case-landing__back">
            ...
            <div>
              ...
              <div className="case-landing__actions">
                <a href="/#contact" className="btn-primary inline-flex justify-center" data-button-field="caseDetailPrimary">
                  {buttonLabels.caseDetailPrimary}
                </a>
                {external ? (
                  <a
                    href={external}
                  ...
                  >
                    {buttonLabels.caseDetailSecondary}
              ...
              <div className="case-landing__cover">
                ...
                <div className="case-landing__cover-frame">
                  <div className="relative aspect-[4/3]">
                    <SiteImage src={data.imageUrl} alt={data.title} fill className="object-cover" />
                  </div>
          ...
          <div className="case-landing__grid case-landing__grid--2">
            <Reveal>
              <div className="case-landing__card">
                <p className="case-landing__card-label">01 · Проблема</p>
      ...
      <section className="case-landing__section case-landing__band">
        <div className="case-landing__inner">
          <Reveal>
            <SectionHeader eyebrow="Продукт" title={data.benefitsTitle} />
          </Reveal>
          <div className="case-landing__grid case-landing__grid--2">
      ...
      <section className="case-landing__cta-wrap">
        <div className="case-landing__inner">
          <CtaBanner
            ...
            primaryLabel={buttonLabels.caseDetailPrimary}
            primaryHref="/#contact"
            secondaryLabel={external ? buttonLabels.caseDetailSecondary : undefined}
            secondaryHref={external ?? undefined}
            variant="accent"
            primaryButtonField="caseDetailPrimary"
            secondaryButtonField="caseDetailSecondary"
          />
        </div>
      </section>
    </article>
