...
INSERT INTO "new_SiteSettings" ("addresses", "brandName", "buttonLabels", "emails", "footerCopyright", "heroHighlight", "heroSubtitle", "heroTitle", "heroVideoUrl", "heroVideoUrlLight", "id", "phones", "sectionSpacing", "socialLinks", "statText", "statValue") SELECT "addresses", "brandName", "buttonLabels", "emails", "footerCopyright", "heroHighlight", "heroSubtitle", "heroTitle", "heroVideoUrl", "heroVideoUrlLight", "id", "phones", "sectionSpacing", "socialLinks", "statText", "statValue" FROM "SiteSettings";
